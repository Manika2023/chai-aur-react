...
// to change the currency type value
...
// it will return all the key from currency => name of other currency corresponding to it
...
return (
  <div
      ...
      style={{
          backgroundImage: `url('https://images.pexels.com/photos/20704817/pexels-photo-20704817/free-photo-of-allee.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load')`,
      }}
  >
